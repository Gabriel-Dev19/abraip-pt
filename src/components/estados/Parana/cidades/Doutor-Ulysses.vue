<template>
    <div>
        <div class="container">
            <h1 class="text-center fs-xs-30 px-xs-4">Detetive particular em Doutor Ulysses - PR</h1>
            <article class="col-lg-11 px-0 mx-auto fs-sm-17 text-center mt-4 fw-500">
                Precisando de <b>Detetive Particular para sua Empresa</b> em <b>Doutor Ulysses - PR?</b>
                A ABRAIP Detetives está em <b>Doutor Ulysses - PR</b> para poder lhe ajudar.
            ...
            <h5 class="text-center fw-600 mt-30">
                Fale com um de nossos especialistas em Doutor Ulysses - PR
            </h5>
...
<script>
import BtnQuatroUm from '../../../buttons/BtnQuatroUm'
export default {
  components: {
    BtnQuatroUm
  },
  metaInfo: {
    ...
    title: 'Detetive Particular em Santa Catarina | Balneário Camboriu | Joinville | Florianópolis | Doutor Ulysses | Blumenal',
