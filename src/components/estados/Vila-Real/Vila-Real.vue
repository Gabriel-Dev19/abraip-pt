<template>
    <div>
        <div class="container">
            <h1 class="text-center fs-xs-30 px-xs-4">Detetive particular em Vila Real</h1>
            <article class="col-lg-11 px-0 mx-auto fs-sm-17 text-center mt-4 fw-500">
                Precisando de <b>Detetive Particular para sua Empresa</b> em <b>Vila Real?</b>
                A ABRAIP Detetives está em <b>Vila Real</b> para poder lhe ajudar.
              ...
              <div class="container px-0">
                ...
                <div class="position-relative overflow-hidden mt-10 col-12 d-flex row mx-auto pr-0 pt-1 pb-30 pl-45">
                    ...
                    <div class="col-lg px-0 mt-4">
                        <a @click.prevent="VilaReal" class="d-flex col-auto px-0 mt-1 py-0 text-preto-cidades fs-sm-17 fw-600 btn align-items-center">
                            <i class="fa fa-angle-right fw-300 fs-25 mr-1"></i> Vila Real
                        </a>
                    </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    VilaReal () {
      this.$router.push('/detetive-particular-em-Vila-Real/detetive-particular-em-Vila-Real')
      this.$smoothScroll({
  ...
  metaInfo: {
    ...
    title: 'Detetive Particular em Vila Real | Porto | Évora  | Braga | Faro | Coimbra | Aveiro',
