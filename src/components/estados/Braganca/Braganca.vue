<template>
    <div>
        <div class="container">
            <h1 class="text-center fs-xs-30 px-xs-4">Detective privado em Bragança</h1>
            <article class="col-lg-11 px-0 mx-auto fs-sm-17 text-center mt-4 fw-500">
                Precisando de <b>Detective Privado para sua Empresa</b> em <b>Bragança?</b>
                A ABRAIP Detectives está em <b>Bragança</b> para poder lhe ajudar.
...
export default {
  ...
  metaInfo: {
    ...
    title: 'Detective Privado em Bragança | Porto | Évora  | Braga | Faro | Coimbra | Aveiro',
