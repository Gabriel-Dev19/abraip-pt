<template>
    <div>
        <div class="container">
            <h1 class="text-center fs-xs-30 px-xs-4">Detetive particular em Goiás</h1>
            <article class="col-lg-11 px-0 mx-auto fs-sm-17 text-center mt-4 fw-500">
                Precisando de <b>Detetive Particular para sua Empresa</b> em <b>Goiás?</b>
                A ABRAIP Detetives está em <b>Goiás</b> para poder lhe ajudar.
        ...
        <section class="pt-80">
            <div class="container">
                ...
                <div class="position-relative overflow-hidden mt-40 col-12 d-flex row mx-auto pr-0 pt-1 pb-30 pl-45">
                        ...
                        <a @click.prevent="Goiania" class="d-flex col-12 mt-4 px-0 py-0 text-preto-cidades fs-sm-17 fw-600 btn align-items-center">
                            <i class="fa fa-angle-right fw-300 fs-25 mr-1"></i> Goiânia – GO
                        </a>
                </div>
            </div>
        </section>
...
export default {
  ...
  methods: {
    Goiania () {
      this.$router.push('/detetive-particular-em-Goias/detetive-particular-em-Goiania')
      this.$smoothScroll({
